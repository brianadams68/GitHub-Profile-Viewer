    ...
    <div>
      <div className="flex justify-center h-11  my-5 items-center">
        <input
          ...
          ref={user}
          type="text"
          className="h-full md:w-1/3 outline-none text-black px-2 
          font-semibold text-lg w-2/3 rounded-xl bg-white"
        />
        <button
          onClick={FindUser}
          className="bg-sky-700 hover:bg-sky-500 font-semibold  px-4 h-full rounded-xl ml-5"
        >
          Search
        </button>
      </div>
